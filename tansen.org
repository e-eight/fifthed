...
|------------+-------+------------+-------------+-------+-------|
| Dragonborn | Monk  | City Watch | Lawful Good |     9 | 16857 |
...
| +2 Blood Spear | Y           | 1d6 (1d8)   | Piercing | 20/60 |
...
- +2 Blood Spear (Requires Attunement) (C)
- Insignia of Claws
